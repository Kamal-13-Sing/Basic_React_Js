...
const initialFormData = {
    ...
    title: '',          // Initialize title field as an empty string
    author: '',         // Initialize author field as an empty string
    price: '',          // Initialize price field as an empty string
    description: ''     // Initialize description field as an empty string
};
